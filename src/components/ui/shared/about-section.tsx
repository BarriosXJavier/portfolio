...
const timeline = [
  {
    ...
    location: "Nairobi",
    description: "Developed web applications using TypeScript and Next.js, ensuring fast load times for improved user engagement. Collaborated with cross-functional teams and conducted testing with Jest.",
  },
  {
    year: "2023",
    ...
    company: "ALX",
    location: "Nairobi",
    description: "Pursuing a rigorous, project-based program in software engineering, focused on problem-solving, systems design, and collaborative development.",
  },
  {
    year: "2024",
    ...
    location: "Nairobi",
    description: "Delivered high-performance web experiences using TypeScript, Next.js, and PostgreSQL. Designed reusable components and collaborated with editorial staff on tech-focused content.",
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6">
              ...
              <span className="text-primary">exceptional</span> digital experiences
            </h2>

            <div className="space-y-4 text-muted-foreground mb-8">
              <p>
                I&apos;m a Frontend Engineer with expertise in TypeScript and Next.js, 
                focused on enhancing user engagement through high-performance web applications.
              </p>
              <p>
                I have a proven track record in delivering cutting-edge solutions, 
                collaborating effectively with teams, and refining user experiences 
                through code review and continuous improvement.
              </p>
              <p>
                When I&apos;m not coding, I&apos;m probably tinkering with low-level stuff,
              ...
              {timeline.map((item, index) => (
                ...
                >
                  ...
                  <div className={cn(
                    ...
                    <p className="text-muted-foreground text-sm">{item.company} • {item.location}</p>
